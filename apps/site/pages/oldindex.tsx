  ...
  return (
    <div>
      <div className="wrapper w-full" >
        <div className="container max-w-3xl mx-auto pb-12 px-4 w-full text-slate-700" >
          ...
          <div id="middle-content" className="grid items-start gap-16 mt-14 grid-cols-1 md:grid-cols-2">
            <div id="learning-materials" className="rounded-3xl shadow-lg px-8 py-10">
              <h2 className="px-4 font-medium text-lg tracking-tight leading-7">Learning materials</h2>
              <a
              ...
              >
                ...
                <span className={listItemLinkTitle}>
                  Documentation
                  <span className={listItemLinkSubTitle}> Everything is in there </span>
                </span>
                <svg
                  className={listItemLinkChevron}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <span className={listItemLinkTitle}>
                  Blog
                  <span className={listItemLinkSubTitle}> Changelog, features & events </span>
                </span>
                <svg
                  className={listItemLinkChevron}
                  fill="none"
              ...
              >
                ...
                <span className={listItemLinkTitle}>
                  YouTube channel
                  <span className={listItemLinkSubTitle}> Nx Show, talks & tutorials </span>
                </span>
                <svg
                  className={listItemLinkChevron}
                  fill="none"
              ...
              >
                ...
                <span className={listItemLinkTitle}>
                  ...
                  <span className={listItemLinkSubTitle}> Create an app, step-by-step </span>
                </span>
                <svg
                  className={listItemLinkChevron}
                  fill="none"
              ...
              >
                ...
                <span className={listItemLinkTitle}>
                  Video courses
                  <span className={listItemLinkSubTitle}> Nx custom courses </span>
                </span>
                <svg
                  className={listItemLinkChevron}
                  fill="none"
            ...
            <div id="other-links">
              ...
              >
                ...
                <span className="px-4 text-lg tracking-tight">
                  Install Nx Console
                  <span className="block text-sm font-light">Plugin for VSCode</span>
                </span>
              </a>
              <div id="nx-cloud" className="rounded-3xl shadow-lg my-8 px-8 py-10">
                <div className="flex items-center">
                  ...
                  <h2 className="px-4 text-lg font-normal tracking-tight leading-7">
                    NxCloud
                    <span className="block text-sm font-light">Enable faster CI & better DX</span>
                  </h2>
                </div>
                <p className="mt-4">
              ...
              >
                ...
                <span className="px-4 text-lg tracking-tight">
                  Nx is open source
                  <span className="block text-sm font-light">Love Nx? Give us a star! </span>
          ...
          <div id="commands" className="rounded-3xl shadow mt-14 px-8 py-10">
            <h2 className="px-4 font-normal text-xl tracking-tight">Next steps</h2>
            <p className="font-light leading-6 mt-4 px-4">Here are some things you can do with Nx:</p>
            ...
            <details className="flex items-center mt-4 px-4 w-full">
              ...
              <pre className="rounded text-gray-200 bg-gray-700 px-2 py-3">
                ...
                nx affected:test
                <span className="block text-gray-400"># run e2e tests for current changes</span>
                nx affected:e2e
              </pre>
            </details>
          </div>

          <p id="love" className="text-gray-500 text-sm mt-14 opacity-60 text-center">
            Carefully crafted with
            <svg
              className="text-red-300 inline w-5 h-5 -mt-1"
              fill="currentColor"
              stroke="none"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
